      ...
      <Container>
        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          <Col md={4} className="project-card">
            <ProjectCard
              imgPath={"/Assets/Projects/StockBox.png"}
              isBlog={false}
              title="Stock Box"
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              imgPath={"/Assets/Projects/PricingTool.png"}
              isBlog={false}
              title="Pricing Tool"
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              imgPath={"/Assets/Projects/Outbook.png"}
              isBlog={false}
              title="Outbook"
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              imgPath={"Assets/Projects/NewSmartAlgo.png"}
              isBlog={false}
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              imgPath={"/Assets/Projects/Esign.png"}
              isBlog={false}
              title="E-Sign"
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              imgPath={"Assets/Projects/Abudhabi.svg"}
              isBlog={false}
              title="Abu Dhabi"
